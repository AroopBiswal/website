...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <svg className="theme-icon theme-icon-sun" viewBox="0 0 24 24" width="20" height="20" aria-hidden focusable="false">
        <circle cx="12" cy="12" r="4" />
        <path d="M12 2v2.5M12 19.5V22M2 12h2.5M19.5 12H22M4.9 4.9l1.8 1.8M17.3 17.3l1.8 1.8M4.9 19.1l1.8-1.8M17.3 6.7l1.8-1.8" />
      </svg>
      <svg className="theme-icon theme-icon-moon" viewBox="0 0 24 24" width="20" height="20" aria-hidden focusable="false">
