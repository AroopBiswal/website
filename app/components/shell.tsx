...
/**
 * One end-piece of the top frame: a rounded corner easing into a short drop
 * down the side, finished with a round cap. Fixed-size SVG so the corner
 * geometry never stretches; the straight run across the top is a flexible
 * div between the left and (mirrored) right copies.
 */
function FrameEnd({ mirrored = false }: { mirrored?: boolean }) {
  return (
    <svg
      width="40"
      height="68"
    ...
    >
      <path
        d="M 40 0.75 H 24.75 A 24 24 0 0 0 0.75 24.75 V 66"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
...
/**
 * Fixed top frame (line + corner end-pieces) and the background strip that
 * hides scrolling content before it reaches the line.
 */
